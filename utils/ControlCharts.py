...
if __name__ == '__main__':
    ...
    s1.makeSeries([1,3,1,4,1], [100, 30, 70, 75, 25], base=[0, 0, 6, 6, -8], gradient = 0.2)
    s2.makeSeries([1,3,4], [50, 150, 100], base=[-5, -5, 2.5], gradient = 0.05)
    s3.makeSeries([4,1,4,3,3], [75, 50, 25, 50, 100], base=[10, 2.5, 0, 5, -2.5], gradient = 0.1)    
